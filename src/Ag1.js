...
import './Ag1.css'
import GridView from './GridViewAg1'
import { useNavigate } from "react-router-dom";

const leftImage = { url: './m-child.png'  };
const rightImage = { url: './f-child.png' };  
    ...
    <div className='bg'>
      ...
      <div className='fmimg'>
        ...
        <div className="mchild">
          <GridView item={leftImage} /> 
        </div>
        <div className="fchild">
          <GridView item={rightImage} /> 
        </div>
      </div>
      ...
      <div className="cap">
        ...
        <h2>What would you like to do today?</h2>
         <button onClick={game} className='gamebtn'>
        ...
        <button onClick={watchyou} className="watchvid-btn">
          ...
          <span className="text1">Videos</span>
          <span className="text2">WatchNow</span> 
        </button>
      </div>
    </div>
 );
