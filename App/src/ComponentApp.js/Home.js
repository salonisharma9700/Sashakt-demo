const Home = () => {
  ...
  let clickHandler = (event) => {
    ...
    // alert(ageuser)
   // age group 1:(8-11) , 2:(12-16)
    if (inputage>=8 && inputage < 12) {
      console.log('hy');
        window.location = "ag1.html";
    }else if (inputage >=12 && inputage < 17) {
      console.log('hy');
        window.location = "ag2.html";
    } else {
      ...
      <div>
        <div>
          ...
          <div className="up">
            ...
            <div className="down">
              <button  className="card3" onClick="window.location = 'https://github.com/salonisharma9700' ">
          ...
          <div className="login-box">
            <form>
              ...
              <div className="user-box">
                <input type="number" name="ageuser" id="ageuser" required />
                <label>Age</label>
              </div>
              <button onClickCapture={clickHandler} className="a" id="a" onClick="age()">
                SEND
                <span />
              </button>
            </form>
